...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    }
.end annotation
...
.field private static mCounrtyGroupECCMap:Ljava/util/HashMap;
...
.field static mGroupCode:Ljava/lang/String;
...
.field static noSIM3GPPECCList:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/telephony/PhoneNumberUtils;->mCounrtyGroupECCMap:Ljava/util/HashMap;
    ...
    .line 180
    invoke-static {}, Landroid/telephony/PhoneNumberUtils;->parseCountryGroupEccConfig()V
    ...
    .line 258
    const-string/jumbo v0, "ro.lenovo.easyimage.code"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Landroid/telephony/PhoneNumberUtils;->mGroupCode:Ljava/lang/String;
    ...
    sput-object v0, Landroid/telephony/PhoneNumberUtils;->noSIM3GPPECCList:[Ljava/lang/String;
...
.method public static getCountryGroupEccMap()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 256
    sget-object v0, Landroid/telephony/PhoneNumberUtils;->mCounrtyGroupECCMap:Ljava/util/HashMap;
...
.method private static isEmergencyNumberInternal(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v26, "[isEmergencyNumber] number: "
    ...
    .line 2024
    .local v17, "numberPlus":Ljava/lang/String;
    if-nez p1, :cond_0
    ...
    const-string v26, ", defaultCountryIso:"
    ...
    .line 2045
    .local v10, "emergencyNumbers":Ljava/lang/String;
    ...
    const-string v26, ", emergencyNumbers: "
    ...
    .line 2065
    const-string/jumbo v24, "ro.ril.ecclist"
    ...
    .end local v10    # "emergencyNumbers":Ljava/lang/String;
    .end local v13    # "i$":I
    .end local v15    # "len$":I
    ...
    .line 2050
    .restart local v10    # "emergencyNumbers":Ljava/lang/String;
    ...
    const-string/jumbo v25, "ril.ecclist"
    ...
    const-string v25, "[isEmergencyNumber]  defaultCountryIso is Empty"
    ...
    const-string/jumbo v24, "isEmergencyNumber"
    ...
    .line 2091
    .local v11, "here":Ljava/lang/RuntimeException;
    invoke-virtual {v11}, Ljava/lang/RuntimeException;->fillInStackTrace()Ljava/lang/Throwable;

    .line 2092
    const-string v24, "CountryIso"

    const-string v25, "^^^^^^^^^^^^^^^^^Call stack trace CountryIso^^^^^ "
    ...
    .line 2096
    .end local v11    # "here":Ljava/lang/RuntimeException;
    :cond_b
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;

    move-result-object v24

    invoke-virtual/range {v24 .. v24}, Landroid/telephony/TelephonyManager;->getSimCountryIso()Ljava/lang/String;

    move-result-object v3

    .line 2097
    .local v3, "SIMIso":Ljava/lang/String;
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    .line 2104
    .local v16, "networkIso":Ljava/lang/String;
    const-string v24, "\\d+"
    ...
    .line 2108
    :cond_c
    new-instance v23, Lcom/android/i18n/phonenumbers/ShortNumberUtil;

    invoke-direct/range {v23 .. v23}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;-><init>()V

    .line 2109
    .local v23, "util":Lcom/android/i18n/phonenumbers/ShortNumberUtil;
    const/16 v24, 0x0

    invoke-static/range {v24 .. v24}, Landroid/telephony/SubscriptionManager;->getSubIdUsingPhoneId(I)I

    move-result v19

    .line 2110
    .local v19, "slot0SubID":I
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v0, v1}, Landroid/telephony/TelephonyManager;->getServiceStateForSubscriber(I)I

    move-result v18

    .line 2111
    .local v18, "slot0State":I
    const/16 v20, 0x3

    .line 2112
    .local v20, "slot1State":I
    const/16 v21, -0x1

    .line 2113
    .local v21, "slot1SubID":I
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    .line 2123
    :cond_f
    sget-object v24, Landroid/telephony/PhoneNumberUtils;->mGroupCode:Ljava/lang/String;
    ...
    .line 2124
    sget-object v24, Landroid/telephony/PhoneNumberUtils;->mCounrtyGroupECCMap:Ljava/util/HashMap;

    sget-object v25, Landroid/telephony/PhoneNumberUtils;->mGroupCode:Ljava/lang/String;

    invoke-virtual/range {v24 .. v25}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;

    .line 2126
    .local v5, "countryGroup":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    if-eqz v5, :cond_10

    invoke-virtual {v5}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->getShowENUI()Z
    ...
    .line 2133
    .end local v5    # "countryGroup":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    :cond_10
    if-eqz p3, :cond_11
    ...
    .line 2140
    :cond_12
    sget-object v24, Landroid/telephony/PhoneNumberUtils;->noSIM3GPPECCList:[Ljava/lang/String;
    ...
    sget-object v25, Landroid/telephony/PhoneNumberUtils;->noSIM3GPPECCList:[Ljava/lang/String;
    ...
    const-string v25, "[isEmergencyNumber] no sim noSIM3GPPECCList: return true"
    ...
    const-string v26, "[isEmergencyNumber] no country code set, using defaultCountryIso:"
    ...
    .line 2157
    .restart local v5    # "countryGroup":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    if-eqz v5, :cond_17

    invoke-virtual {v5}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->getNoSIMOnly3GPPECC()Z
    ...
    .line 2163
    invoke-virtual {v5}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->getCountryISO()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v6}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;->isEmergencyNumber(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v26, "[isEmergencyNumber] return true, no SIM countryISO:"
    ...
    const-string v25, "[isEmergencyNumber] no match"
...
.method private static parseCountryGroupEccConfig()V
    .locals 12

    .prologue
    .line 191
    sget-object v10, Landroid/telephony/PhoneNumberUtils;->mCounrtyGroupECCMap:Ljava/util/HashMap;
    ...
    const-string v11, "XmlPullParserFactory.newPullParser() return null"
    ...
    const-string v10, "/system/etc/country_group_emergency_number_config.xml"
    ...
    .line 205
    .local v8, "record":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    :goto_1
    const/4 v10, 0x1
    ...
    .line 209
    new-instance v8, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;

    .end local v8    # "record":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    invoke-direct {v8}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;-><init>()V

    .line 210
    .restart local v8    # "record":Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;
    ...
    .line 215
    invoke-virtual {v8, v9}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->setGroupCode(Ljava/lang/String;)V
    ...
    .line 217
    invoke-virtual {v8, v9}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->setCountryISO(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string/jumbo v11, "parseCountryGroupEccConfig: finished"
    ...
    :cond_4
    :try_start_1
    const-string v10, "NoSIMOnly3GPPECC"
    ...
    invoke-virtual {v8, v10}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->setNoSIMOnly3GPPECC(Z)V
    :try_end_1
    ...
    invoke-virtual {v8, v10}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->setShowENUI(Z)V
    :try_end_2
    ...
    invoke-virtual {v8, v10}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->setInServiceECC(Z)V
    ...
    invoke-virtual {v8}, Landroid/telephony/PhoneNumberUtils$CountryGroupEccEntry;->getGroupCode()Ljava/lang/String;
