.class public Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1187
    sget-object v1, Lcom/lenovo/internal/R$styleable;->ScrollingViewBehavior_Params:[I
    ...
    iput v1, p0, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->mOverlayTop:I
...
.method private static findFirstAppBarLayout(Ljava/util/List;)Llenovo/design/widget/AppBarLayout;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    instance-of v3, v1, Llenovo/design/widget/AppBarLayout;

    if-eqz v3, :cond_0

    .line 1293
    check-cast v1, Llenovo/design/widget/AppBarLayout;
...
.method public getOverlayTop()I
    ...
    .prologue
    .line 1286
    iget v0, p0, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->mOverlayTop:I
...
.method public onDependentViewChanged(Llenovo/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 1251
    .local v1, "behavior":Llenovo/design/widget/CoordinatorLayout$Behavior;
    instance-of v5, v1, Llenovo/design/widget/AppBarLayout$Behavior;

    if-eqz v5, :cond_0

    .line 1254
    check-cast v1, Llenovo/design/widget/AppBarLayout$Behavior;

    .end local v1    # "behavior":Llenovo/design/widget/CoordinatorLayout$Behavior;
    invoke-virtual {v1}, Llenovo/design/widget/AppBarLayout$Behavior;->getTopBottomOffsetForScrollingSibling()I
    ...
    iget v6, p0, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->mOverlayTop:I
    ...
    iget v5, p0, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->mOverlayTop:I

    if-eqz v5, :cond_1

    instance-of v5, p3, Llenovo/design/widget/AppBarLayout;
    ...
    invoke-virtual {p3}, Llenovo/design/widget/AppBarLayout;->getTotalScrollRange()I
    ...
    invoke-static {v3, v2, v5}, Llenovo/design/widget/AnimationUtils;->lerp(IIF)I

    move-result v5

    invoke-virtual {p0, v5}, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->setTopAndBottomOffset(I)Z
...
.method public onMeasureChild(Llenovo/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    :cond_1
    invoke-static {v9}, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->findFirstAppBarLayout(Ljava/util/List;)Llenovo/design/widget/AppBarLayout;

    move-result-object v6

    .line 1217
    .local v6, "appBar":Llenovo/design/widget/AppBarLayout;
    if-eqz v6, :cond_5

    invoke-virtual {v6}, Llenovo/design/widget/AppBarLayout;->isLaidOut()Z
    ...
    .line 1218
    invoke-virtual {v6}, Llenovo/design/widget/AppBarLayout;->getFitsSystemWindows()Z
    ...
    .line 1229
    :cond_3
    invoke-virtual {v6}, Llenovo/design/widget/AppBarLayout;->getMeasuredHeight()I

    move-result v0

    sub-int v0, v7, v0

    invoke-virtual {v6}, Llenovo/design/widget/AppBarLayout;->getTotalScrollRange()I
    ...
    .line 1237
    invoke-virtual/range {v0 .. v5}, Llenovo/design/widget/CoordinatorLayout;->onMeasureChild(Landroid/view/View;IIII)V
    ...
    .line 1243
    .end local v6    # "appBar":Llenovo/design/widget/AppBarLayout;
...
.method public setOverlayTop(I)V
    ...
    .prologue
    .line 1279
    iput p1, p0, Llenovo/design/widget/AppBarLayout$ScrollingViewBehavior;->mOverlayTop:I
