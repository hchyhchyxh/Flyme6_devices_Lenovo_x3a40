...
.method public scheduleSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;JJZ)V
    ...
    .line 754
    .local v40, "expedited":Ljava/lang/Boolean;
    ...
    .line 795
    .local v51, "removeDuplicatedContactsSync":Z
    new-instance v39, Ljava/util/HashSet;

    invoke-direct/range {v39 .. v39}, Ljava/util/HashSet;-><init>()V

    .line 796
    .local v39, "contactsSyncedAccount":Ljava/util/HashSet;, "Ljava/util/HashSet<Landroid/accounts/Account;>;"
    const/4 v3, -0x1
    ...
    const-string v3, "share_contacts_sms_between_user"
    ...
    .line 800
    .local v38, "contactsShared":Z
    :goto_1
    move/from16 v51, v38

    .line 803
    .end local v38    # "contactsShared":Z
    ...
    .end local v39    # "contactsSyncedAccount":Ljava/util/HashSet;, "Ljava/util/HashSet<Landroid/accounts/Account;>;"
    .end local v43    # "i$":I
    .end local v44    # "ignoreSettings":Z
    .end local v49    # "len$":I
    .end local v50    # "manualSync":Z
    .end local v51    # "removeDuplicatedContactsSync":Z
    .end local v57    # "uploadOnly":Z
    :cond_7
    move-object/from16 v0, p0
    ...
    .line 783
    .restart local v44    # "ignoreSettings":Z
    .restart local v50    # "manualSync":Z
    .restart local v57    # "uploadOnly":Z
    :cond_9
    if-eqz v50, :cond_a
    ...
    .line 798
    .restart local v39    # "contactsSyncedAccount":Ljava/util/HashSet;, "Ljava/util/HashSet<Landroid/accounts/Account;>;"
    .restart local v51    # "removeDuplicatedContactsSync":Z
    .restart local v52    # "resolver":Landroid/content/ContentResolver;
    :cond_c
    const/16 v38, 0x0
    ...
    .line 813
    .local v56, "syncableAuthorities":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    move-object/from16 v0, p0
    ...
    check-cast v53, Landroid/content/pm/RegisteredServicesCache$ServiceInfo;

    .line 814
    .local v53, "syncAdapter":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    ...
    .line 820
    .end local v53    # "syncAdapter":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    :cond_e
    if-eqz p4, :cond_f
    ...
    .line 826
    .end local v41    # "hasSyncAdapter":Z
    :cond_f
    invoke-virtual/range {v56 .. v56}, Ljava/util/HashSet;->iterator()Ljava/util/Iterator;
    ...
    .line 835
    .local v54, "syncAdapterInfo":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    if-eqz v54, :cond_10
    ...
    .line 867
    .restart local v55    # "syncAllowed":Z
    :cond_16
    if-eqz v51, :cond_19
    ...
    const-string v5, "remove Duplicated Contacts Sync "
    ...
    .line 878
    :cond_19
    new-instance v45, Lcom/android/server/content/SyncStorageEngine$EndPoint;
    ...
    .line 881
    .local v45, "info":Lcom/android/server/content/SyncStorageEngine$EndPoint;
    move-object/from16 v0, p0
