...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 5511
    iput v6, p0, Lcom/android/server/audio/AudioService;->mCurrentUserId:I
...
.method static synthetic access$8300(Lcom/android/server/audio/AudioService;)I
    ...
    .prologue
    .line 164
    iget v0, p0, Lcom/android/server/audio/AudioService;->mCurrentUserId:I
...
.method static synthetic access$8302(Lcom/android/server/audio/AudioService;I)I
    ...
    .prologue
    .line 164
    iput p1, p0, Lcom/android/server/audio/AudioService;->mCurrentUserId:I
...
.method private killBackgroundUserProcessesWithRecordAudioPermission(Landroid/content/pm/UserInfo;)V
    ...
    .line 5672
    .local v2, "homeActivityName":Landroid/content/ComponentName;
    ...
    invoke-virtual {v9, v10}, Landroid/app/ActivityManagerInternal;->getHomeActivityForUser(I)Landroid/content/ComponentName;
    ...
    invoke-interface {v9, v5, v10, v11}, Landroid/content/pm/IPackageManager;->getPackagesHoldingPermissions([Ljava/lang/String;II)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {v9, v1}, Landroid/util/AndroidRuntimeException;-><init>(Ljava/lang/Exception;)V
    ...
    const-string v10, "com.lenovo.recorder"

    if-eq v9, v10, :cond_4

    iget-object v9, v6, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    const-string v10, "com.lenovo.fm"
    ...
    const-string v10, "Force stopping to CANCEL NOTIFICATION OF RECORDER!!!"
    ...
    invoke-virtual {v0, v9, v10}, Landroid/app/ActivityManager;->forceStopPackageAsUser(Ljava/lang/String;I)V
    :try_end_1
    ...
    const-string v10, "Error calling killUid"
    ...
    const-string v12, "killBackgroundUserProcessesWithAudioRecordPermission"

    invoke-interface {v9, v10, v11, v12}, Landroid/app/IActivityManager;->killUid(IILjava/lang/String;)V
    :try_end_2
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "need to lower notification volume to index "
...
.method public isAppHasAudioFocus(ILjava/lang/String;)Z
    .locals 1
    .param p1, "uid"    # I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/audio/MediaFocusControl;->isAppHasAudioFocus(ILjava/lang/String;)Z
