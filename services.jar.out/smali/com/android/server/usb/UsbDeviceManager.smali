...
.field private static final USB_PERSISTENT_DATA_UNLOCK_PROPERTY:Ljava/lang/String; = "persist.sys.usb.data_unlock"
...
.method public setUsbDataUnlocked(Z)V
    ...
    const-string v3, "setUsbDataUnlocked("
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/usb/UsbDeviceManager;->isChargeOnly:Z
    ...
    :goto_1
    const-string v1, "persist.sys.usb.data_unlock"
    ...
    invoke-virtual {v1, v2, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendMessage(IZ)V
...
.method public systemReady()V
    ...
    .line 255
    :goto_3
    const-string v5, "persist.sys.usb.data_unlock"
    ...
    invoke-static {v5, v7}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$302(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Z)Z

    .line 257
    iget-object v5, p0, Lcom/android/server/usb/UsbDeviceManager;->mHandler:Lcom/android/server/usb/UsbDeviceManager$UsbHandler;

    # getter for: Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbDataUnlocked:Z
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$300(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    ...
    const-string v8, "ADB_ENABLED is restricted."
