...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v65, Landroid/util/Pair;

    .line 2105
    .local v65, "val":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/lang/Long;Ljava/lang/String;>;"
    if-nez v65, :cond_15
    ...
    .end local v65    # "val":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/lang/Long;Ljava/lang/String;>;"
    check-cast v65, Landroid/util/Pair;

    .line 2108
    .restart local v65    # "val":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/lang/Long;Ljava/lang/String;>;"
    :cond_15
    if-eqz v65, :cond_17
    ...
    check-cast v62, Lcom/android/server/am/AppTimeTracker;

    .line 2188
    .local v62, "tracker":Lcom/android/server/am/AppTimeTracker;
    move-object/from16 v0, p0
    ...
    .line 2191
    .end local v62    # "tracker":Lcom/android/server/am/AppTimeTracker;
    :sswitch_24
    move-object/from16 v0, p0
    ...
    .line 2206
    .local v59, "targetIntent":Landroid/content/Intent;
    if-eqz v59, :cond_0
    ...
    .line 2210
    .local v52, "protectedAppIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    const-class v8, Lcom/android/internal/app/FwdActivity;

    move-object/from16 v0, v52

    invoke-virtual {v0, v4, v8}, Landroid/content/Intent;->setClass(Landroid/content/Context;Ljava/lang/Class;)Landroid/content/Intent;
    ...
    invoke-virtual/range {v59 .. v59}, Landroid/content/Intent;->getAction()Ljava/lang/String;
    ...
    const-string v8, "this is a task movement intent instead of APP"

    invoke-static {v4, v8}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 2218
    const-string v4, "com.lenovo.protected.intent.MOVE_PROTECTED_TARGET_INTENT"
    ...
    .line 2223
    .end local v52    # "protectedAppIntent":Landroid/content/Intent;
    .end local v59    # "targetIntent":Landroid/content/Intent;
    :sswitch_27
    move-object/from16 v0, p0
