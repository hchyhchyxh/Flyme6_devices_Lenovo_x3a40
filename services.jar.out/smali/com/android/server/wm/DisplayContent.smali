...
.method getLogicalDisplayRect(Landroid/graphics/Rect;)V
    ...
    .line 189
    .local v4, "physHeight":I
    :goto_2
    iget-object v11, p0, Lcom/android/server/wm/DisplayContent;->mDisplayInfo:Landroid/view/DisplayInfo;

    iget v8, v11, Landroid/view/DisplayInfo;->logicalWidth:I
    ...
    iget v1, v11, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    iget-object v12, p0, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iget v12, v12, Lcom/android/server/wm/WindowManagerService;->mTvDisplayId:I
    ...
    .line 196
    const-string v11, "sys.wfd.enhanced.forcerotation"
    ...
    invoke-virtual {p1, v9, v9, v10, v11}, Landroid/graphics/Rect;->set(IIII)V

    .line 205
    .end local v0    # "forceRotation":I
    :goto_3
    return-void

    .end local v1    # "height":I
    .end local v2    # "left":I
    .end local v4    # "physHeight":I
    .end local v5    # "physWidth":I
    ...
    invoke-virtual {p1, v2, v7, v9, v10}, Landroid/graphics/Rect;->set(IIII)V
