...
.method private static isPreloaded(Ljava/io/File;)Z
    .locals 6
    ...
    const-string v5, "Unable to access code path "
...
.method createNewUserLILPw(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/PackageManagerService;->getSystemImes()Ljava/util/List;

    move-result-object v10

    .line 3715
    .local v10, "sysImes":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 3721
    iget v0, v9, Lcom/android/server/pm/PackageSetting;->pkgFlags:I

    and-int/lit8 v0, v0, 0x1

    if-nez v0, :cond_1

    iget-object v0, v9, Lcom/android/server/pm/PackageSetting;->codePath:Ljava/io/File;

    invoke-static {v0}, Lcom/android/server/pm/Settings;->isPreloaded(Ljava/io/File;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/PackageManagerService;->isAppBlockedForSecureUser(Ljava/lang/String;)Z
    ...
    const-string v2, "blocked app: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, v9, Lcom/android/server/pm/PackageSetting;->pkg:Landroid/content/pm/PackageParser$Package;
    ...
    :cond_2
    :goto_2
    invoke-virtual {v9, v6, p3}, Lcom/android/server/pm/PackageSetting;->setInstalled(ZI)V

    .line 3739
    iget-object v1, v9, Lcom/android/server/pm/PackageSetting;->volumeUuid:Ljava/lang/String;
    ...
    .line 3747
    .local v8, "nativeLibPath":Ljava/lang/String;
    const/16 v0, 0xa

    if-ne p3, v0, :cond_3

    const-string v0, "service.encfs-data.status"
    ...
    iget-object v1, v9, Lcom/android/server/pm/PackageSetting;->pkg:Landroid/content/pm/PackageParser$Package;

    iget-object v1, v1, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;

    invoke-virtual {p2, v0, v1, v8, p3}, Lcom/android/server/pm/Installer;->linkNativeLibraryDirectory(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    const-string v1, "Failed linking native library dir"
    ...
    .line 3721
    .end local v8    # "nativeLibPath":Ljava/lang/String;
    :cond_4
    const/4 v6, 0x0
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/pm/PackageManagerService;->isMandatoryAppForSecureUser(Landroid/content/pm/PackageParser$Package;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/PackageManagerService;->isLauncherableApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/PackageManagerService;->isPresetAppForSecureUser(Ljava/lang/String;)Z
    ...
    const-string v2, "Launcher app not preset: "
    ...
    .line 3752
    .restart local v8    # "nativeLibPath":Ljava/lang/String;
    :cond_8
    const-string v0, "PackageSettings"

    const-string v1, "secure user but encfs-data is umounted"
