...
.field private static final MIN_USER_ID:I = 0xf
...
.method private createUserInternal(Ljava/lang/String;II)Landroid/content/pm/UserInfo;
    ...
    .restart local v13    # "isSecureUser":Z
    ...
    :try_start_a
    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->findCurrentSecureUserLocked()Landroid/content/pm/UserInfo;
    ...
    const-string v29, "create secure user already exists"
    ...
    const-string v26, "panzh2"

    new-instance v29, Ljava/lang/StringBuilder;

    invoke-direct/range {v29 .. v29}, Ljava/lang/StringBuilder;-><init>()V

    const-string v30, "volumeUuid = "
    ...
    .restart local v19    # "userDir":Ljava/io/File;
    .restart local v23    # "vol":Landroid/os/storage/VolumeInfo;
    .restart local v24    # "volumeUuid":Ljava/lang/String;
    :cond_e
    :try_start_13
    const-string v26, "panzh2"

    const-string v29, "already exist userDir"
    ...
    const-string v26, "ro.lenovo.encfs"
    ...
    const-string v29, "create encfs for secure user"
    ...
    .line 1338
    const-string v26, "service.encfs-data.status"
    ...
    const-string v29, "encfs data folder is in service"
    ...
    .line 1343
    .local v25, "wait_cycles":I
    :try_start_17
    const-string v26, "ctl.start"

    const-string v29, "encfs-data-mount"
    ...
    const-string v29, "start encfs data service fatal error"
...
.method private findCurrentSecureUserLocked()Landroid/content/pm/UserInfo;
    .locals 5
    ...
    .line 1416
    .local v2, "user":Landroid/content/pm/UserInfo;
    invoke-virtual {v2}, Landroid/content/pm/UserInfo;->isSecureUser()Z
...
.method finishRemoveUser(I)V
    ...
    const-string v0, "ro.lenovo.encfs"
    ...
    const-string v2, "Cleanup secure user data repository"
