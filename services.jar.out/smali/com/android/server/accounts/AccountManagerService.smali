...
.method private hasSecureUser()Z
    .locals 8
...
.method private isCrossUser(II)Z
    ...
    invoke-direct {p0}, Lcom/android/server/accounts/AccountManagerService;->getCallingPackageName()Ljava/lang/String;

    move-result-object v0

    .line 718
    .local v0, "callingPkg":Ljava/lang/String;
    const-string v6, "share_contacts_sms_between_user"
    ...
    const-string v6, "android.uid.shared"
    ...
    invoke-direct {p0, v6}, Lcom/android/server/accounts/AccountManagerService;->temporarilyGrantPermission(I)V
    ...
    const-string v5, "enforce cross user permission not granted"
    ...
    .restart local v2    # "isCrossUser":Z
    :cond_2
    if-eqz v2, :cond_3
...
.method private needHackForGlobalContacts()Z
    .locals 5
    ...
    .line 2833
    :cond_2
    invoke-direct {p0}, Lcom/android/server/accounts/AccountManagerService;->hasSecureUser()Z
...
.method private temporarilyGrantPermission(I)V
    .locals 2
    .param p1, "uid"    # I
    ...
    :try_start_0
    invoke-interface {v0, p1}, Landroid/content/pm/IPackageManager;->temporarilyGrantPermission(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getAccounts(Ljava/lang/String;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    invoke-direct {p0}, Lcom/android/server/accounts/AccountManagerService;->needHackForGlobalContacts()Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/accounts/AccountManagerService;->temporarilyGrantPermission(I)V

    .line 2859
    invoke-virtual {p0}, Lcom/android/server/accounts/AccountManagerService;->getAllZonesAccounts()[Landroid/accounts/AccountAndUser;

    move-result-object v1

    .line 2860
    .local v1, "accountsUser":[Landroid/accounts/AccountAndUser;
    if-eqz v1, :cond_0
    ...
    .end local v1    # "accountsUser":[Landroid/accounts/AccountAndUser;
    .end local v2    # "i":I
    :cond_0
    invoke-static {}, Landroid/os/UserHandle;->getCallingUserId()I
    ...
    invoke-virtual {p0, p1, v3, p2}, Lcom/android/server/accounts/AccountManagerService;->getAccountsAsUser(Ljava/lang/String;ILjava/lang/String;)[Landroid/accounts/Account;
...
.method public getAllZonesAccounts()[Landroid/accounts/AccountAndUser;
    .locals 3
