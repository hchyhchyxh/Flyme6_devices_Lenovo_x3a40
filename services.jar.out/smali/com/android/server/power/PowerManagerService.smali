...
.field private mWfdNappingReason:I
...
.method static synthetic access$4500(Lcom/android/server/power/PowerManagerService;JII)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
    .param p3, "x2"    # I
    ...
    .prologue
    .line 99
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/power/PowerManagerService;->wfdNapInternal(JII)V
...
.method static synthetic access$5500(Lcom/android/server/power/PowerManagerService;ZII)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$6000(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$WakeLock;Z)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Lcom/android/server/power/PowerManagerService$WakeLock;
    .param p2, "x2"    # Z
...
.method static synthetic access$6200(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;Ljava/lang/String;IFIIJ)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Landroid/os/IBinder;
...
.method static synthetic access$6700(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$BackLightPropertiesDeath;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6702(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$BackLightPropertiesDeath;)Lcom/android/server/power/PowerManagerService$BackLightPropertiesDeath;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6800(Lcom/android/server/power/PowerManagerService;)Landroid/hardware/display/DisplayManagerInternal;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private wakeUpNoUpdateLocked(JLjava/lang/String;ILjava/lang/String;I)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z

    .line 1160
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mNotifier:Lcom/android/server/power/Notifier;

    iget-boolean v1, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z

    iget v2, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingReason:I

    invoke-virtual {v0, v1, v2}, Lcom/android/server/power/Notifier;->onWfdNappingMode(ZI)V

    .line 1161
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingReason:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/lights/Light;->refreshBrightness(Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method private wfdNapInternal(JII)V
    .locals 3
    .param p1, "eventTime"    # J
    .param p3, "uid"    # I
    .param p4, "reason"    # I
    ...
    .line 1274
    :try_start_0
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/power/PowerManagerService;->wfdNapNoUpdateLocked(JII)Z
...
.method private wfdNapNoUpdateLocked(JII)Z
    .locals 7
    .param p1, "eventTime"    # J
    .param p3, "uid"    # I
    .param p4, "reason"    # I
    ...
    const-string v3, "WFD Nap time (uid "
    ...
    iput-boolean v1, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z

    .line 1294
    iput p4, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingReason:I

    .line 1295
    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mNotifier:Lcom/android/server/power/Notifier;

    iget-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z

    iget v3, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingReason:I

    invoke-virtual {v1, v2, v3}, Lcom/android/server/power/Notifier;->onWfdNappingMode(ZI)V

    .line 1298
    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mBacklight:Lcom/android/server/lights/Light;

    iget-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mWfdNappingEnabled:Z

    invoke-virtual {v1, v2}, Lcom/android/server/lights/Light;->refreshBrightness(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
# virtual methods
.method public getWakeLocksInternal()Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2933
    .local v1, "wakelocks":Ljava/util/List;, "Ljava/util/List<Landroid/os/PowerManagerInternal$WakeLockInfo;>;"
    ...
    new-instance v3, Landroid/os/PowerManagerInternal$WakeLockInfo;
    ...
    iget v7, v2, Lcom/android/server/power/PowerManagerService$WakeLock;->mFlags:I

    invoke-direct {v3, v5, v6, v7}, Landroid/os/PowerManagerInternal$WakeLockInfo;-><init>(Ljava/lang/String;II)V
