...
.field private static final P2P_PERSISTENT_PSK_FAIL:Ljava/lang/String; = "P2P-PERSISTENT-PSK-FAIL"

.field public static final P2P_PERSISTENT_PSK_FAIL_EVENT:I = 0x24050
...
.method private getPskFailGroup(Ljava/lang/String;)I
    .locals 4
...
.method private handleP2pEvents(Ljava/lang/String;)V
    ...
    .end local v0    # "device":Landroid/net/wifi/p2p/WifiP2pDevice;
    :cond_2
    const-string v4, "P2P-FIND-STOPPED"
    ...
    invoke-direct {v6, p1}, Landroid/net/wifi/p2p/WifiP2pConfig;-><init>(Ljava/lang/String;)V
    ...
    .line 1271
    :cond_4
    const-string v4, "P2P-GO-NEG-SUCCESS"
    ...
    .line 1273
    :cond_5
    const-string v4, "P2P-GO-NEG-FAILURE"
    ...
    .line 1275
    :cond_6
    const-string v4, "P2P-GROUP-FORMATION-SUCCESS"
    ...
    .line 1277
    :cond_7
    const-string v4, "P2P-GROUP-FORMATION-FAILURE"
    ...
    :cond_9
    const-string v4, "P2P-GROUP-REMOVED"
    ...
    .end local v1    # "group":Landroid/net/wifi/p2p/WifiP2pGroup;
    :cond_a
    const-string v4, "P2P-INVITATION-RECEIVED"
    ...
    invoke-direct {v6, p1}, Landroid/net/wifi/p2p/WifiP2pGroup;-><init>(Ljava/lang/String;)V
    ...
    .line 1288
    :cond_b
    const-string v4, "P2P-INVITATION-RESULT"
    ...
    .line 1290
    :cond_c
    const-string v4, "P2P-PROV-DISC-PBC-REQ"
    ...
    new-instance v6, Landroid/net/wifi/p2p/WifiP2pProvDiscEvent;

    invoke-direct {v6, p1}, Landroid/net/wifi/p2p/WifiP2pProvDiscEvent;-><init>(Ljava/lang/String;)V
    ...
    .line 1293
    :cond_d
    const-string v4, "P2P-PROV-DISC-PBC-RESP"
    ...
    .line 1296
    :cond_e
    const-string v4, "P2P-PROV-DISC-ENTER-PIN"
    ...
    .line 1299
    :cond_f
    const-string v4, "P2P-PROV-DISC-SHOW-PIN"
    ...
    .line 1302
    :cond_10
    const-string v4, "P2P-PROV-DISC-FAILURE"
    ...
    .line 1304
    :cond_11
    const-string v4, "P2P-SERV-DISC-RESP"
    ...
    invoke-virtual {v4, v5, v3}, Lcom/android/internal/util/StateMachine;->sendMessage(ILjava/lang/Object;)V
    ...
    const-string v6, "Null service resp "
    ...
    :cond_13
    const-string v4, "P2P-REMOVE-AND-REFORM-GROUP"
    ...
    .line 1315
    :cond_14
    const-string v4, "P2P-PERSISTENT-PSK-FAIL"
    ...
    .line 1317
    invoke-direct {p0, p1}, Lcom/android/server/wifi/WifiMonitor;->getPskFailGroup(Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v5, v2}, Lcom/android/internal/util/StateMachine;->sendMessage(II)V
